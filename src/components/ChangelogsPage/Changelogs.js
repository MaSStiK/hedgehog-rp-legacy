...
• Добавлен выбор беседы при создании новости из сообщения в ВК`,
    ...
    {
        title: "Переезд в Telegram",
        text: `После переезда в Telegram создание поста из сообщения временно недоступно. Бросание игральной кости уже работает, результат отправляется в группу.`,
        date: "15.08.2025",
    }
]
