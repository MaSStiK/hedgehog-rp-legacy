...
• Праздничный задний фон доступен во вкладке Настройки > Задний фон страницы > Праздничный.
• Так же появились две новые главы истории рп, они уже доступны во вкладке "Помощь".`,
        date: "30.05.2025",
    },
]
