...
• Посты 3 сезона теперь помечены текстом "Сезон 3"
• Добавлено отображение автора поста вместо названия страны
• Добавлена возможность изменить автора поста при создании и редактировании поста (По умолчанию название страны)
• Добавлено короткое пояснение для настройки кнопка "Наверх страницы"
• На телефонах с маленьким экраном скрывается текст кнопок под постом`,
        date: "09.07.2024",
        attach: [],
    },
]
