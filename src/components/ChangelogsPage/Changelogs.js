...
Она уже доступна по ссылке https://hedgehog-rp.ru/support/rp_lore_chapter1 или во вкладке "Помощь"
Так же обновлены картинки в статьях`,
        date: "28.05.2025",
    },
    // {
    //     title: "Праздничная тема",
    //     text: `Доступна новая тема приуроченная в честь пятилетия проекта Ежиное РП, тема доступна во вкладке "Настройки" > Эффекты страницы > Праздничная тема`,
    //     date: "30.05.2025",
    // },
]
