...
• Добавлена возможность редактировать свои новости
...
• Добавлен полноэкранный предпросмотр картинки на страницах: создание/редактирование новости, редактирование профиля участника и страны (Так же добавлен текст указывающий на предпросмотр картинки)
• Изменено отображение списка загруженных картинок при создании/редактировании новости, так же загруженные картинки можно посмотреть в полноэкранном режиме
• Минимальный размер картинки в новости уменьшен с 40px до 20px
...
• Добавлен "Предпросмотр" новости на странице с новостью если она была открыта по ссылке
