...
const seasons = [
    ...
    {img: imgSeason6, chapter: "VI", start: "22 августа 2025, 01:27 МСК", link: "https://hedgehog-rp.ru/news", planet: "Кулсториробоб и Динахон", system: "Двойная звезда HD 52265 - Солнце", desc: "Спасение цивилизации пришло совсем скоро и неожиданно - Солнце и подобная ему звезда объединились, чтобы дать шанс жизни не только Кулсториробобу и Земле, но и другим экзопланетам и суперземлям в новобразованной системе."},
]
