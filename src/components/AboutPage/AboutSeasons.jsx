...
const seasons = [
    {img: imgSeason1, chapter: "I", link: "/support/rp_lore_chapter1", planet: "Кулсториробоб", system: "Бетальгейзе", desc: "Социалистическая империя рухнула под давлением сепаратистов. В разгар вспыхнувшей гражданской войны между социалистами, национал-демократами и монархистами Даниил Вудергорский объявил о создании Ежиной Армии."},
    {img: imgSeason2, chapter: "II", link: "/support/rp_lore_chapter2", planet: "Кулсториробоб", system: "Бетальгейзе", desc: "Нашествие саурианцев вынудило 10 000 кулсториробян бежать на лунную сторону планеты. Они оказались в опасном мире, где уже господствовали гиены. Вокруг спасшихся стихийно сформировались новые силы: Инквизиция (Рим), Греческие царства (Ежи), Сицилия (Шотландия), а также укрывшиеся Пепси, Змеи, Лефаны и Единороги. Выживание в этом непрощающем мире стало их единственной целью."},
    {img: imgSeason3, chapter: "III", link: "/support/rp_lore_chapter3", planet: "Кулсториробоб", system: "Бетальгейзе", desc: "После разгрома претоиранцев, установилась Греческая доминация и мировое спокойствие. На холодном севере все крепче вставала на ноги Романья, последний наследник Рима. Но беда пришла, откуда не ждали: в Ежинии и Велуке коварные империалисты внезапно прорвались к власти."},
    {img: imgSeason4, chapter: "IV", link: "/support/rp_lore_chapter4", planet: "Динахон", system: "Базиликс", desc: "Столкнувшись с гибелью вселенной от Черной Звезды Бетельгейзе, боги Йешуа, Зевс, Гея и Эвиллиан создали новую вселенную в отчаянной попытке спасти жизнь. На планете Динахон, в полной изоляции друг от друга, медленно развивались народы Дикобразов, Утожей, Людей и Кентавров. Эпоха примитивного мира закончилась, когда жажда ресурсов привела дикобразов к войне со Скелетами."},
    {img: imgSeason5, chapter: "V", link: "/support/rp_lore_chapter5", planet: "Кулсториробоб и Динахон", system: "Бетальгейзе и Базиликс", desc: "Операция по спасению вселенной Базиликс от Бетельгейзе закончилась извержением из белой дыры поглощенный Кулсториробоб. Экспедиции с Динахона (Кентаврия, СДСР, КРИВС) и Ариралы с Аркейна обнаружили планету, опустошенную катастрофой. Они основали аванпосты, но быстро поняли, что столкнулись не с пустой землей, а с руинами более древней и развитой цивилизации."},
]
                        ...
                        <div className="season" key={i}>
                            <div className="flex-col season__content" style={{width: seasonWidth}}>
                                ...
                                <div className="flex-col season__info">
                                    ...
                                    <h4>Планета: {season.planet}<br />Система: {season.system}</h4>
                                    <p>{season.desc}</p>
