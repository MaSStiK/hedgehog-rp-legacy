...
Это старая версия платформы для ролевой игры внутри нашей вселенной.  
...
- Система рекомендаций и дополнительного контента
...
- **react-range** — интерактивные ползунки и диапазоны
- **react-zoom-pan-pinch** — масштабирование и перемещение изображений
